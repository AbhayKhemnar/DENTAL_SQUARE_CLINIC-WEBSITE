    ...
    <section className="bg-slate-950 py-14 text-white sm:py-20">
      <div className="section-shell">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-sm font-extrabold uppercase tracking-widest text-amber-100">Why choose us</p>
          <h2 className="mt-3 text-3xl font-black leading-tight tracking-normal sm:text-5xl">
            Why patients choose Perfect Smile Dental Clinic.
          </h2>
        </div>
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {whyChooseUs.map((item, index) => (
            ...
            >
              <item.icon className="text-3xl text-amber-100" />
